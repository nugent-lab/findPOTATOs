...
def generate_xml(filename, data, obs_data):
    ...
    Args:
        data: dictionary, the first half of the ADES fields
    ...
    measurers_name.text = data["measurers"]
